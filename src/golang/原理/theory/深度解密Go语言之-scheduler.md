...
![系列文章目录](https://static.studygolang.com/190902/4eed86fd1edd43bcffad9201517dfe91.png)
...
![Go 语言核心编程技术](https://static.studygolang.com/190902/602ba900990f28ad4fa14e035b867983.png)
...
等待状态。线程在等待某件事的发生。例如等待网络数据、硬盘；调用操作系统 API；等待内存同步访问条件 ready，如 atomic, mutexes

Runnable

就绪状态。只要给 CPU 资源我就能运行

Executing

运行状态。线程在执行指令，这是我们想要的
...
要想���解 Go scheduler 的底层原理，对于函数调用过程的理解是必不可少的。它涉��到函数参数的传递，CPU 的指令跳转，函数返回值的传递等等。这需要对汇编语言有一定的了解，因为只有汇编语言才能进行像寄存器赋值这样的底层操作。之前的一些文章里也有说明，这里再来复习一遍。

> 函数栈帧的空间主要由函数参数和返回值、局部变量和被调用其它函数的参数和返回值空间组成。

宏观看一下，Go 语言中函数调用的规范，引用曹大博客里的一张图：

![曹大 asmshare 函数调用规范](https://static.studygolang.com/190902/4aaa622ddaf65135097530cb607710c9.png)
...
![M:N scheduling](https://static.studygolang.com/190902/11baaef991964b4ec3a121530488cd7e.png)
...
![runtime overall](https://static.studygolang.com/190902/68714518eb3b96f7be0dbccc2519b3f7.png)
...
![Go scheduler goals](https://static.studygolang.com/190902/ff11f4721f1a5972fd04db163be81dc6.png)
...
![Go scheduler limitations](https://static.studygolang.com/190902/ca9760b58b3f37422d93dd4d41c5d436.png)
...
![mac 硬件信息](https://static.studygolang.com/190902/ed2f6ce7cf9c93ea46e414f33dc9b88e.png)
...
![GPM global review](https://static.studygolang.com/190902/eb0cf1dd27171f63bfb5151784edf9d0.png)
...
![goroutine workflow](https://static.studygolang.com/190902/ce62525ce76060abe1bf5756fff4bd0b.png)
...
![GPM relatioship](https://static.studygolang.com/190902/cf34a5b466865e37ed5a7166b45bd574.png)
...
![Work Stealing](https://static.studygolang.com/190902/241ac4dc79a77ac90fc33291743b140d.png)
...
![同步系统调用](https://static.studygolang.com/190902/57f09f1cedfb353c242e95530433bc7e.png)
...
![异步系统调用](https://static.studygolang.com/190902/7daa57ae26866156db45164aa08bbff4.png)
...
至于为什么最后打印出的 x 为 0，之前的文章[《曹大谈内存重排》](https://link.juejin.im?target=https%3A%2F%2Fqcrao.com%2F2019%2F06%2F17%2Fcch-says-memory-reorder%2F)里有讲到过，这里不再深究了。
...
【知乎回答，怎样理解阻塞非阻塞与同步异步的区别】？[www.zhihu.com/question/19…](https://link.juejin.im?target=https%3A%2F%2Fwww.zhihu.com%2Fquestion%2F19732473%2Fanswer%2F241673170)

【从零开始学架构 Reactor与Proactor】[book.douban.com/subject/303…](https://link.juejin.im?target=https%3A%2F%2Fbook.douban.com%2Fsubject%2F30335935%2F)

【思否上 goalng 排名第二的大佬译文】[segmentfault.com/a/119000001…](https://link.juejin.im?target=https%3A%2F%2Fsegmentfault.com%2Fa%2F1190000016038785)

【ardan labs】[www.ardanlabs.com/blog/2018/0…](https://link.juejin.im?target=https%3A%2F%2Fwww.ardanlabs.com%2Fblog%2F2018%2F08%2Fscheduling-in-go-part1.html)

【论文 Analysis of the Go runtime scheduler】[www.cs.columbia.edu/~aho/cs6998…](https://link.juejin.im?target=http%3A%2F%2Fwww.cs.columbia.edu%2F~aho%2Fcs6998%2Freports%2F12-12-11_DeshpandeSponslerWeiss_GO.pdf)

【译文传播很广的】[morsmachine.dk/go-schedule…](https://link.juejin.im?target=https%3A%2F%2Fmorsmachine.dk%2Fgo-scheduler)

【码农翻身文章】[mp.weixin.qq.com/s/BV25ngvWg…](https://link.juejin.im?target=https%3A%2F%2Fmp.weixin.qq.com%2Fs%2FBV25ngvWgbO3_yMK7eHhew)

【goroutine 资料合集】[github.com/ardanlabs/g…](https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Fardanlabs%2Fgotraining%2Ftree%2Fmaster%2Ftopics%2Fgo%2Fconcurrency%2Fgoroutines)

【大彬调度器系列文章】[lessisbetter.site/2019/03/10/…](https://link.juejin.im?target=http%3A%2F%2Flessisbetter.site%2F2019%2F03%2F10%2Fgolang-scheduler-1-history%2F)

【Scalable scheduler design doc 2012】[docs.google.com/document/d/…](https://link.juejin.im?target=https%3A%2F%2Fdocs.google.com%2Fdocument%2Fd%2F1TTj4T2JO42uD5ID9e89oa0sLKhJYD0Y_kqxDv3I3XMw%2Fedit%23heading%3Dh.rvfa6uqbq68u)

【Go scheduler blog post】[morsmachine.dk/go-schedule…](https://link.juejin.im?target=https%3A%2F%2Fmorsmachine.dk%2Fgo-scheduler)

【work stealing】[rakyll.org/scheduler/](https://link.juejin.im?target=https%3A%2F%2Frakyll.org%2Fscheduler%2F)

【Tony Bai 也谈goroutine调度器】[tonybai.com/2017/06/23/…](https://link.juejin.im?target=https%3A%2F%2Ftonybai.com%2F2017%2F06%2F23%2Fan-intro-about-goroutine-scheduler%2F)

【Tony Bai 调试实例分析】[tonybai.com/2017/11/23/…](https://link.juejin.im?target=https%3A%2F%2Ftonybai.com%2F2017%2F11%2F23%2Fthe-simple-analysis-of-goroutine-schedule-examples%2F)

【Tony Bai goroutine 是如何工作的】[tonybai.com/2014/11/15/…](https://link.juejin.im?target=https%3A%2F%2Ftonybai.com%2F2014%2F11%2F15%2Fhow-goroutines-work%2F)

【How Goroutines Work】[blog.nindalf.com/posts/how-g…](https://link.juejin.im?target=https%3A%2F%2Fblog.nindalf.com%2Fposts%2Fhow-goroutines-work%2F)

【知乎回答 什么是阻塞，非阻塞，同步，异步？】[www.zhihu.com/question/26…](https://link.juejin.im?target=https%3A%2F%2Fwww.zhihu.com%2Fquestion%2F26393784%2Fanswer%2F328707302)

【知乎文章 完全理解同步/异步与阻塞/非阻塞】[zhuanlan.zhihu.com/p/22707398](https://link.juejin.im?target=https%3A%2F%2Fzhuanlan.zhihu.com%2Fp%2F22707398)

【The Go netpoller】[morsmachine.dk/netpoller](https://link.juejin.im?target=https%3A%2F%2Fmorsmachine.dk%2Fnetpoller)

【知乎专栏 Head First of Golang Scheduler】[zhuanlan.zhihu.com/p/42057783](https://link.juejin.im?target=https%3A%2F%2Fzhuanlan.zhihu.com%2Fp%2F42057783)

【鸟窝 五种 IO 模型】[colobu.com/2019/07/26/…](https://link.juejin.im?target=https%3A%2F%2Fcolobu.com%2F2019%2F07%2F26%2FIO-models%2F)

【Go Runtime Scheduler】[speakerdeck.com/retervision…](https://link.juejin.im?target=https%3A%2F%2Fspeakerdeck.com%2Fretervision%2Fgo-runtime-scheduler%3Fslide%3D32)

【go-scheduler】[povilasv.me/go-schedule…](https://link.juejin.im?target=https%3A%2F%2Fpovilasv.me%2Fgo-scheduler%2F%23)

【追踪 scheduler】[www.ardanlabs.com/blog/2015/0…](https://link.juejin.im?target=https%3A%2F%2Fwww.ardanlabs.com%2Fblog%2F2015%2F02%2Fscheduler-tracing-in-go.html)

【go tool trace 使用】[making.pusher.com/go-tool-tra…](https://link.juejin.im?target=https%3A%2F%2Fmaking.pusher.com%2Fgo-tool-trace%2F)

【goroutine 之旅】[medium.com/@riteeksriv…](https://link.juejin.im?target=https%3A%2F%2Fmedium.com%2F%40riteeksrivastava%2Fa-complete-journey-with-goroutines-8472630c7f5c)

【介绍 concurreny 和 parallelism 区别的视频】[www.youtube.com/watch?v=cN\_…](https://link.juejin.im?target=https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3DcN_DpYBzKso%26amp%3Bt%3D422s)

【scheduler 的陷阱】[www.sarathlakshman.com/2016/06/15/…](https://link.juejin.im?target=http%3A%2F%2Fwww.sarathlakshman.com%2F2016%2F06%2F15%2Fpitfall-of-golang-scheduler)

【boya 源码阅读】[github.com/zboya/golan…](https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Fzboya%2Fgolang_runtime_reading%2Fblob%2Fmaster%2Fsrc%2Fruntime%2Fproc.go)

【阿波张调度器系列教程】[mp.weixin.qq.com/mp/homepage…](https://link.juejin.im?target=http%3A%2F%2Fmp.weixin.qq.com%2Fmp%2Fhomepage%3F__biz%3DMzU1OTg5NDkzOA%3D%3D%26amp%3Bhid%3D1%26amp%3Bsn%3D8fc2b63f53559bc0cee292ce629c4788%26amp%3Bscene%3D18%23wechat_redirect)

【曹大 asmshare】[github.com/cch123/asms…](https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Fcch123%2Fasmshare%2Fblob%2Fmaster%2Flayout.md)

【Go调度器介绍和容易忽视的问题】[www.cnblogs.com/CodeWithTxT…](https://link.juejin.im?target=https%3A%2F%2Fwww.cnblogs.com%2FCodeWithTxT%2Fp%2F11370215.html)

【最近发现的一位大佬的源码分析】[github.com/changkun/go…](https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Fchangkun%2Fgo-under-the-hood%2Fblob%2Fmaster%2Fbook%2Fzh-cn%2FTOC.md)
