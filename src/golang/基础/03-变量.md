...
这是我们 [Golang 系列教程](/subject/2)的第 3 个教程，探讨 Golang 里的变量（Variables）。

你可以阅读 Golang 系列 [**教程第 2 部分：Hello World**](/articles/11755)，学习如何配置 Golang，并运行 Hello World 程序。
...
```
[在线运行��序](https://play.golang.org/p/EYTtRnlDu3)
