...
这是我们 [Golang 系列教程](/subject/2)的第 4 个教程。

请阅读本系列的 [Golang 教程第 3 部分：变量](/articles/11756) 来学习变量的知识。
...
在上���的程序里，c1 和 c2 是两个复数。c1的实部为 5，虚部为 7。c2 的实部为8，虚部为 27。c1 和 c2 的和赋值给 `cadd` ，而 c1 和 c2 的乘积赋值给 `cmul`。该程序将输出：
```
sum: (13+34i)  
product: (-149+191i)  
```
